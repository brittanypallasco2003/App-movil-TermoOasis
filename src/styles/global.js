...
const globalStyles = StyleSheet.create({
  ...
  infoRegistros: {
    ...
    flex: 1,
    alignItems:'center',
    marginHorizontal: isTablet ? moderateScale(15) : moderateScale(15),
    marginBottom:isTablet ? moderateScale(20) : moderateScale(15),
  },
  iconMedicina: {
    elevation: 10,
    backgroundColor: "#3F8483",
  ...
  contReceta: {
    ...
    paddingTop: verticalScale(15),
    // width,
    width: isTablet ? moderateScale(360) : moderateScale(270),
    // width: isTablet ? moderateScale(340) : moderateScale(330),
    marginHorizontal: isTablet ? moderateScale(15) : moderateScale(20),
    justifyContent: "center",
    paddingBottom: verticalScale(15),
